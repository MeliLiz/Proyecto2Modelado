 ...
 * Esta cuenta tiene un límite de retiro y cobra un interés al depositar más de una cantidad determinada
 */
public class CuentaBasica extends CuentaBancaria {
     ...
     * @param cvv          El cvv de la cuenta bancaria, es con lo que se verifica la cuenta
    ...
    /**
     * Método para depositar dinero en la cuenta. Esta cuenta cobra el 3% del depósito si la cantidad a depositar es mayor a $2000
     * 
    ...
    /**
     * Método para obtener el interés que se cobra al depositar más de la cantidad de pivoteInteres
    ...
    /**
     * Método para cambiar la cantidad de interés que se cobrará al depositar más de la cantidad del pivoteInteres
    ...
    /**
     * Método para obtener la cantidad de depósito a partir de la cual se cobrará el interés
     * @return double la cantidad a partir de la cual se cobra el inteŕes del depósito
     */
    ...
    /**
     * Método para cambiar la cantidad de depósito a partir de la cual se cobrará el interés
     * @param pivoteInteres La cantidad a partir de la cual se cobra el inteŕes del depósito
     */
