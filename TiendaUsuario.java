...
public class TiendaUsuario implements Serializable {
    ...
    public void inicio() {
        ...
        if (this.tipoUsuario.equals("usuario")) {// Si el usuario es un usuario normal
            // El número de libros gratis que tiene la tienda desde la última vez que el
            // usuario visitó su cuenta
            if (usuario.getNumLibrosGratis() != 0) {
                vistaTienda.mostrarNumLibrosGratis(usuario.getNumLibrosGratis());
                usuario.setNumLibrosGratis(0);
            }
            // Mostrar al usuario las opciones de la tienda: ver catalogo, comprar, ir a su
            // biblioteca o salir
     ...
     * 
     * @param respuesta La respuesta que envió la vista: 1 para mostrar catáogo, 2
     *                  para comprar libros, 3 para ir a la biblioteca del usuario,
     *                  4 para salir
     */
     ...
     * 
     * @param respuesta La respuesta que envió la vista: 1 para registrar un libro
     *                  nuevo en la tienda, 2 para salir
     */
    ...
    /**
     * Método para ver los libros disponibles en la biblioteca del usuario y dar las
     * opciones de lectura
     * 
     ...
     * 
     * @param respuesta La respuesta de que envió la vista: 1 para agregar libros al
     *                  carrito, 2 para ir al inicio
     */
     ...
     * 
     * @param respuesta 1 si se quiere pagar lo que hay en el carrito, 2 para
     *                  regresar al inicio
     */
